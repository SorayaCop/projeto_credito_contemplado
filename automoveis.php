...
<meta charset="utf-8">
  ...
  width: 100%;
  height: 50vh;
  background: url(images/bg-automoveis.jpg) top center fixed;
        ...
        <div class="container">
            ...
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    ...
                    <li><a href="<?= $BASE_URL ?>imoveis.php">Contemplada Imóveis</a></li>
        ...
        <div class="hero-container">
            <div class="wow fadeIn">
                ...
                <div class="actions">
                    ...
                    <a href="#autos" class="btn-services">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; veículos
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                </div>
            </div>
        </div>
            ...
            <div class="content-wrapper">
                ...
                <div class="row mx-1" id="imoveis">
                    <?php foreach ($autos as $autos): ?>
                        ...
                        <div  class="col-12 card-contempladas mb-3 mb-lg-4" id="cotas-container">
                            <div class="row pt-2">
                                <div class="col-2 col-lg-1 text-end text-primary" style="font-size: 40px !important">
                                    <span class="fa fa-car" style="color: black"></span>
                                    <!--icon-->
                                </div>
                                ...
                                <div class="col-2 col-lg-2 pt-2 d-none d-lg-block">
                                    <img src="<?= $autos["logo"] ?>" alt="" style="max-width: 270px !important" />
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 pt-2">
                                    <div class="form-check" class="align-middle">
                                        <input type="checkbox" name="cota[]" id="" class="form-check-input check-soma"
                                            style="cursor: pointer" data-id="<?= $autos["codigo"] ?>"
                                            data-credito="<?= $autos["credito_calculo"] ?>"
                                            data-categoria="<?= $autos["categoria"] ?>"
                                            data-prazo="<?= $autos["prazo"] ?>"
                                            data-valor-parcela="<?= $autos["parcela_calculo"] ?>" data-transfer="0"
                                            data-seguro="0" data-fundo="0" data-garantia="0"
                                            data-entrada="<?= $autos["entrada_calculo"] ?>"
                                            data-administradora="<?= $autos["administradora"] ?>"
                                            data-status="<?= $autos["condicao"] ?>" data-msg-whats="*Cota Código: 
                                            <?= $autos["codigo"] ?>* | <?= $autos["categoria"] ?>: 
                                            *<?= $autos["valor_credito"] ?>* | Entrada: *<?= $autos["valor_entrada"] ?>* 
                                            | Parcelas restantes: *<?= $autos["prazo"] ?>* x *<?= $autos["valor_parcela"] ?>
                                            *  | Administradora: *<?= $autos["administradora"] ?>*/>
                                ...
                                <div class="col-4 col-lg-3 offset-lg-2 px-0 d-grid gap-1">
                                    <button href="#" class="btn btn-sm btn-dark py-1 px-0 mx-1 mx-lg-2 "
                                        ...
                                        data-bs-target=".modal-contempladas-detalhes-<?= $autos["modal"] ?>">
                                ...
                                <div class="col-4 col-lg-3 px-0 d-grid gap-1">
                                    <a class="btn btn-sm btn-<?= $imoveis["cor_btn."] ?> py-1 px-0 mx-1 mx-lg-2"
                                        ...
                                        href="https://api.whatsapp.com/send?phone=550000000000&text=Ol%C3%A1,%20vim%20pelo%20site!%20Tenho%20interesse%20pela%20contemplada:%20%0AAdministradora:%20*<?= $autos["administradora"] ?>*%0AModalidade:%20*Imóveis*%0ACr%C3%A9dito:%20*<?= $autos["valor_credito"] ?>*%0AEntrada:%20*<?= $autos["valor_entrada"] ?>*%0AParcelas:%20*<?= $autos["prazo"] ?>*%20x%20*<?= $autos["valor_parcela"] ?>*%0ASaldo%20Devedor:%20*<?= $autos["valor_saldo"] ?>*%0AC%C3%B3d:%20*<?= $autos["codigo"] ?>*%0A">
                                        <span class="<?= $autos["icon_btn"] ?>" style="font-size: 12px"></span>&nbsp;
                                        <?= $autos["condicao"] ?>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="modal fade modal-contempladas-detalhes-<?= $autos["moda."] ?>" tabindex="-1"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="background-color: #f6f6f6">
                                        <div class="row">
                                            <div class="col-12 text-start" style="font-size: 14px; line-height: 1.6rem"
                                                ...
                                                <br />
                                                <br />
                                                Situação: <b class="text-<?= $autos["cor_btn"] ?>">
                                                    <?= $autos["condicao"] ?>
                                                </b>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        <a class="btn btn-sm btn-warning text-secondary py-1 py-lg-2 px-2 px-lg-3 mx-1 mx-lg-2"
                                            style="font-size: 12px !important" target="_blank"
                                            href="https://api.whatsapp.com/send?phone=&text=Administradora:%20*<?= $autos["administradora"] ?>*%0AModalidade:%20*Imóveis*%0ACr%C3%A9dito:%20*<?= $autos["valor_credito"] ?>*%0AEntrada:%20*<?= $autos["valor_entrada"] ?>*%0AParcelas:%20*<?= $autos["prazo"] ?>*%20x%20*<?= $autos["valor_parcela"] ?>*%0ASaldo%20Devedor:%20*<?= $autos["valor_saldo"] ?>*%0AC%C3%B3d:%20*<?= $autos["codigo"] ?>*">
